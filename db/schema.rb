...
ActiveRecord::Schema.define(version: 20151113194515) do
  ...
  add_index "student_payments", ["student_id", "due_date"], name: "index_student_payments_on_student_id_and_due_date", unique: true, using: :btree
